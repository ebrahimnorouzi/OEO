 ...
 * [oeo.yml](oeo.yml)
     * Determines how your purl.obolibrary.org/obo/oeo/ redirects will be handled
     ...
     * Paste in the contents of [oeo.yml](oeo.yml)
 ...
 * [oeo.md](oeo.md)
     ...
     * Paste in the contents of [oeo.md](oeo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
